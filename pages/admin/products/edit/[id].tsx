...
import { addProduct, listProduct } from '../../../../src/features/products/product.slice'
...
const EditProduct = (props: Props) => {
    ...
    useEffect(() => {
        (async () => {
            const productz = await dispatch(listProduct(id))
                                    ...
                                    <div className="max-w-lg mx-auto">
                                        <form onSubmit={handleSubmit(onAdd)}>
                                            ...
                                            <div className="mb-6">
                                                ...
                                                {errors.name && <span className='text-rose-600'>Không được để trống!</span>}
                                            </div>
                                            <div className="mb-6">
                                                ...
                                                <input type="text" {...register('price', { required: true })}
                                                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                    placeholder="Price" />
                                                {errors.price && <span className='text-rose-600'>Không được để trống!</span>}
                                            </div>
                                            <div className="mb-6">
                                                <label htmlFor="password"
                                                ...
                                                <input type="text" {...register('desc', { required: true })}
                                                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                    placeholder="Desc" />
                                                {errors.desc && <span className='text-rose-600'>Không được để trống!</span>}
                                            </div>
                                            <div className="mb-6">
                                                <label htmlFor="password"
                                            ...
                                            {errors.img && <span className='text-rose-600'>Không được để trống!</span>}
                                            <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400 mt-4">Chọn danh mục</label>
                                            ...
                                            {errors.category && <span className='text-rose-600'>Không được để trống!</span>}
                                            ...
                                            <button type="submit"
                                                ...
                                                rounded-lg text-sm px-5 py-2.5 text-center mt-4"
                                            >Submit</button>
                                        </form>
                                    </div>

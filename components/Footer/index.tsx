                    ...
                    <div className="footer dp-grid reveal mt-8">
                        <div className="shop_system">
                            ...
                            <div className="list_system">
                                ...
                                <img src="https://theme.hstatic.net/1000340796/1000856039/14/logo-bct.png?v=4" className="temp" />
                            </div>
                        </div>
                        ...
                        <div className="connect mx-auto">
                            ...
                            <div className="social">
                                <div className="item dp-flex align-items">
                                    <a href=""> <img src="https://res.cloudinary.com/dsirnbuyv/image/upload/v1654737346/fb_av0kmw.png" /></a>
                                    <a className="remove__underline" href="">Facebook</a>
                                </div>
                                <div className="item dp-flex align-items">
                                    <a href=""> <img src="https://res.cloudinary.com/dsirnbuyv/image/upload/v1654737346/insta_tkjicf.png" /></a>
                                    <a className="remove__underline" href="">Instagram</a>
                                </div>
                                <div className="item dp-flex align-items">
                                    <a href=""> <img src="https://res.cloudinary.com/dsirnbuyv/image/upload/v1654737346/Group_ki1mvp.png" /></a>

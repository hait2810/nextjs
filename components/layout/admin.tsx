               ...
               <div className="px-3 py-3 lg:px-5 lg:pl-3">
                  <div className="flex items-center justify-between">
                     <div className="flex items-center justify-start">
                        ...
                        <Script src="https://cdn.tailwindcss.com/3.1.4?plugins=forms@0.5.2,typography@0.5.2,aspect-ratio@0.4.0,line-clamp@0.4.0" />
                        <a href="./index.html" className="text-xl font-bold flex items-center lg:ml-2.5">

                           <img src="https://res.cloudinary.com/dsirnbuyv/image/upload/v1658578748/1619593227974-ClownZ_-_logo_1_iz726o.png" className="h-14 ml"
                              alt="Windster Logo" />
                     ...
                     <div className="flex items-center">
                        ...
                        <div className="hidden lg:flex items-center">
                           <div className="-mb-1">
                              <a className="github-button" href="#" data-size="large" data-show-count="true"
                           ...
                           <ul className="space-y-2 pb-2">
                              ...
                              <li>
                                 <a href="/admin/carts"
                                    ...
                                    <span className="ml-3 flex-1 whitespace-nowrap">Đơn Hàng</span>
                                 </a>
                              </li>
                              <li>
                                 <a href="#"
                                    ...
                                    <span className="ml-3 flex-1 whitespace-nowrap">Bình Luận</span>
                                 </a>
                              </li>
                              <li>
                                 <a href="#"
                              ...
                              <li>
                                 <a href="#" target="_blank"
                                    ...
                                    <span
                                       className="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">Pro</span>
                                 </a>
                              </li>
                              <li>
                                 <a href="#" target="_blank"
                              ...
                              <div className="block w-full overflow-x-auto">
                                 <table className="items-center w-full bg-transparent border-collapse">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                       ...
                                       <tr className="text-gray-500">
                                          <th
                                             className="border-t-0 align-middle text-sm font-normal whitespace-nowrap p-4 pb-0 text-left">
                                             Email</th>
                                          <td
                                             className="border-t-0 align-middle text-xs font-medium text-gray-900 whitespace-nowrap p-4 pb-0">
                                             456</td>
                  ...
                  <footer
                     ...
                     <ul className="flex items-center flex-wrap mb-6 md:mb-0">
                        ...
                        <li><a href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Privacy
                           Policy</a></li>
                        <li><a href="#" className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6">Licensing</a>
                        </li>
